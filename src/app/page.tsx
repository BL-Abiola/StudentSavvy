    ...
    <SidebarProvider defaultOpen={true}>
      <Sidebar className="border-r">
        ...
        <SidebarFooter className="p-2">
           <Button variant="ghost" size="icon" onClick={() => setShowSettings(true)} className="w-full justify-start px-3 gap-3 rounded-2xl hover:bg-primary hover:text-primary-foreground">
      ...
      <SidebarInset>
        <header className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-3">
             <SidebarTrigger className="hidden md:flex hover:bg-primary hover:text-primary-foreground rounded-full" />
